...
def choose_rule(rule_dict, chosen_rule, title):
    ...
    rule_right_layout = [
        ...
        [sg.Multiline(rule_dict[chosen_rule],size=(40,8),key='explanation')],
    ...
    while True: 
        ...
        if rule_event == sg.WIN_CLOSED:
            ...
            chosen_rule = rule_values['selected_rule'][0]
            rule_window.Element('explanation').Update(value=rule_dict[chosen_rule])
    rule_window.close()
...
#         if params_event == sg.WIN_CLOSED:
#             break
#         elif params_event == 'Choose':
#             chosen_rule = params_values['selected_rule'][0]
#             break
#         elif params_values['selected_rule'][0] != chosen_rule:
#             chosen_rule = params_values['selected_rule'][0]
#             params_window.Element('explanation').Update(value=params_dict[chosen_rule])
#     params_window.close()
...
main_left_layout = [
    ...
    [sg.Text("Enviroment rule set:  ",font=font, size=(15,1)), sg.Multiline(default_text= "Rule1",font=font, key='chosen_env_rule',size=(10,1),no_scrollbar=True), sg.Button("Choose", key='env_rule')],
    [sg.Text("Cell rule set:  ",font=font, size=(15,1)), sg.Multiline(default_text= "Rule1",font=font, key='chosen_cell_rule',size=(10,1),no_scrollbar=True), sg.Button("Choose", key='cell_rule')],
